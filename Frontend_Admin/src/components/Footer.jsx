                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <div>
                                <div className="text-xl font-bold tracking-[0.3em]">QUECOS</div>
                                <div className="text-[#b8812e] text-[10px] tracking-[0.2em] -mt-1">STEAK HOUSE</div>
                            </div>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Estamos esperándote a tí y a tus familiares o amigos, ¡Ven a pasarla genial!
                        </p>

                        {/* Social Media */}
                        <div className="flex space-x-4 pt-2">
                            <a 
                                href="https://www.facebook.com/people/Quecos-Steak-House/100083254935356/" 
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 bg-white/5 hover:bg-[#b8812e] rounded-full flex items-center justify-center transition-all duration-300 group cursor-pointer"
                                aria-label="Facebook"
                            >
                            ...
                            <a 
                                href="https://www.instagram.com/quecossteakhouse/" 
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 bg-white/5 hover:bg-[#b8812e] rounded-full flex items-center justify-center transition-all duration-300 group cursor-pointer"
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start space-x-3">
                                ...
                                <span className="text-gray-400">
                                    Alajuela, San Carlos, La Marina<br />
                                    700m este del Zoologico
                                </span>
                            </li>
                            ...
                            <li className="flex items-center space-x-3">
                                ...
                                <a href="mailto:quecosteakhouse@hotmail.com" className="text-gray-400 hover:text-[#b8812e] transition-colors">
                                    quecosteakhouse@hotmail.com
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-400 text-sm text-center md:text-left">
                            &copy; {currentYear} Quecos Steak House. Todos los derechos reservados.
                        </p>
