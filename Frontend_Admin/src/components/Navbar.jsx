...
const Navbar = () => {
    ...
    const navLinkClass = ({ isActive }) =>
        `px-3 lg:px-3 py-2 rounded-sm transition-colors duration-200 text-sm lg:text-base whitespace-nowrap ${isActive ? 'bg-red-700 text-white' : 'hover:bg-red-800 text-gray-200'
        }`;

    const mobileNavLinkClass = ({ isActive }) =>
        `block px-3 py-2 rounded-sm transition-colors duration-200 text-gray-200 ${isActive ? 'bg-red-700 text-white' : 'hover:bg-red-800'
        }`;
